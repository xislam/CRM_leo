...
class Migration(migrations.Migration):
    ...
    replaces = [('account', '0001_initial'), ('account', '0002_studentportfolio_create_date_en_and_more'), ('account', '0003_student_telegram_user_id_and_more'), ('account', '0004_project_deadline_compliance_project_group_grade_and_more'), ('account', '0005_project_total_rating'), ('account', '0006_remove_project_total_rating_student_total_rating')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grade', models.CharField(default=0, max_length=250, verbose_name='Оценка')),
                ('grade_en', models.CharField(default=0, max_length=250, null=True, verbose_name='Оценка')),
                ('grade_es', models.CharField(default=0, max_length=250, null=True, verbose_name='Оценка')),
                ('grade_ru', models.CharField(default=0, max_length=250, null=True, verbose_name='Оценка')),
                ...
                ('deadline_compliance', models.FloatField(default=0, max_length=10, verbose_name='Соблюдение дедлайнов')),
                ('group_grade', models.FloatField(default=0, max_length=10, verbose_name='Групповая оценка')),
                ('intricacy_coefficient', models.FloatField(default=0, max_length=10, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(1.5)], verbose_name='Коэффициент сложности')),
                ('manager_recommendation', models.FloatField(default=0, max_length=10, verbose_name='Рекомендация менеджера')),
                ('personal_grade', models.FloatField(default=0, max_length=10, verbose_name='Личная оценка')),
            ],
            options={
                'verbose_name': 'Проект',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile_phone_en', models.CharField(max_length=15, null=True, verbose_name='Мобильный телефон')),
                ('mobile_phone_es', models.CharField(max_length=15, null=True, verbose_name='Мобильный телефон')),
                ('mobile_phone_ru', models.CharField(max_length=15, null=True, verbose_name='Мобильный телефон')),
                ...
                ('gender_en', models.CharField(max_length=10, null=True, verbose_name='Пол')),
                ('gender_es', models.CharField(max_length=10, null=True, verbose_name='Пол')),
                ('gender_ru', models.CharField(max_length=10, null=True, verbose_name='Пол')),
                ...
                ('manager_status', models.CharField(choices=[('Manager Lead', 'Лид менеджера'), ('In Progress with Manager', 'В работе у менеджера'), ('Rejected', 'Отказ'), ('Awaiting Payment', 'Ожидает оплаты'), ('Partially Paid', 'Частично оплачен'), ('Paid', 'Оплачен')], max_length=20, verbose_name='Статус менеджера')),
                ('manager_status_en', models.CharField(choices=[('Manager Lead', 'Лид менеджера'), ('In Progress with Manager', 'В работе у менеджера'), ('Rejected', 'Отказ'), ('Awaiting Payment', 'Ожидает оплаты'), ('Partially Paid', 'Частично оплачен'), ('Paid', 'Оплачен')], max_length=20, null=True, verbose_name='Статус менеджера')),
                ('manager_status_es', models.CharField(choices=[('Manager Lead', 'Лид менеджера'), ('In Progress with Manager', 'В работе у менеджера'), ('Rejected', 'Отказ'), ('Awaiting Payment', 'Ожидает оплаты'), ('Partially Paid', 'Частично оплачен'), ('Paid', 'Оплачен')], max_length=20, null=True, verbose_name='Статус менеджера')),
                ('manager_status_ru', models.CharField(choices=[('Manager Lead', 'Лид менеджера'), ('In Progress with Manager', 'В работе у менеджера'), ('Rejected', 'Отказ'), ('Awaiting Payment', 'Ожидает оплаты'), ('Partially Paid', 'Частично оплачен'), ('Paid', 'Оплачен')], max_length=20, null=True, verbose_name='Статус менеджера')),
                ('education_status', models.CharField(choices=[('Registration for Free Subscription', 'Регистрация на бесплатную подписку'), ('Completed Free Subscription', 'Завершена бесплатная подписка'), ('Paid Subscription Participant', 'Участник платной подписки'), ('Course Participant', 'Участник курса'), ('Dropout', 'Выбыл'), ('Completed Education', 'Завершил обучение')], max_length=40, verbose_name='Статус обучения')),
                ('education_status_en', models.CharField(choices=[('Registration for Free Subscription', 'Регистрация на бесплатную подписку'), ('Completed Free Subscription', 'Завершена бесплатная подписка'), ('Paid Subscription Participant', 'Участник платной подписки'), ('Course Participant', 'Участник курса'), ('Dropout', 'Выбыл'), ('Completed Education', 'Завершил обучение')], max_length=40, null=True, verbose_name='Статус обучения')),
                ('education_status_es', models.CharField(choices=[('Registration for Free Subscription', 'Регистрация на бесплатную подписку'), ('Completed Free Subscription', 'Завершена бесплатная подписка'), ('Paid Subscription Participant', 'Участник платной подписки'), ('Course Participant', 'Участник курса'), ('Dropout', 'Выбыл'), ('Completed Education', 'Завершил обучение')], max_length=40, null=True, verbose_name='Статус обучения')),
                ('education_status_ru', models.CharField(choices=[('Registration for Free Subscription', 'Регистрация на бесплатную подписку'), ('Completed Free Subscription', 'Завершена бесплатная подписка'), ('Paid Subscription Participant', 'Участник платной подписки'), ('Course Participant', 'Участник курса'), ('Dropout', 'Выбыл'), ('Completed Education', 'Завершил обучение')], max_length=40, null=True, verbose_name='Статус обучения')),
        ...
        migrations.AddField(
            model_name='student',
            name='total_rating',
            field=models.FloatField(default=0, max_length=255, verbose_name='Общий рейтинг'),
        ),
    ]
